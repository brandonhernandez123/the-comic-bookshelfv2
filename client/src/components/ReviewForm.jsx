    ...
    return(
        <div>
            <form onSubmit={() => onClick(props.index)}>
                ...
                <input type='range' min={1} max={10} placeholder='Rate out of 10' name='rating'   onChange={handleChangeRating} />
                <button id='submitbtn' required type='submit' placeholder='submit'>Submit  </button>
            </form>
        </div>
    )
}
