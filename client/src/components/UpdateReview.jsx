    ...
    return(
        <Container>
            ...
            <form onSubmit={() => updatedReview(props.index)}>
                <label>Review</label>
                <input type='text' required placeholder={props.review} id='reviewform' name='review' onChange={handleChangeReview} />
                <br/>
                <label>Rating: </label>
                <input type='number'  required min={1} max={10} placeholder={props.rating} name='rating'  onChange={handleChangeRating} />
                <br/>
