...
export const CHARACTER_COMIC_VINE = 'http://www.comicvine.com/api/characters?api_key='
export const format = '&format=json'
export const SingleCharacter = 'http://comicvine.gamespot.com/api/character/'
export const SearchbyIssue = 'http://www.comicvine.com/api/issues?api_key='
