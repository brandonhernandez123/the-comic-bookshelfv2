          ...
          <Accordion.Collapse className="accordion" eventKey="0">
            <Col className="dcsearch">
              <form onSubmit={getSearchResults}>
                <h2>
                  Search <span id="comicvine">Comic</span>{' '}
                  <span id="vine">Vine's</span> Database
                </h2>
                <input
                  type="text"
                ...
                <p>
                  When searching ComicVine, you need to search by the title of
                  the comic, example: Gotham By Gaslight, New Krypton etc
                </p>
                <br />
                <h5>
                  {' '}
                  You have the option of filtering by Release date (both dates
                  must be filled)
                </h5>
                <p>
                  example: Searching Batman 08/01/2022 - 06/03/2022 will return
                  results with Batman in the title(not series/volume)
                </p>
                <input
                  type="date"
                  placeholder="date"
          ...
          <Accordion.Collapse className="accordion" eventKey="1">
            <Col>
              <form className="dcsearch" onSubmit={FetchMarvel}>
                <h2>
                  Search <span id="marvel">Marvel's</span> database
                </h2>
                <input
                  type="text"
                ...
                <p>
                  example: To retrieve a more recent The Amazing Spider-Man
                  issue you would search The Amazing Spider-Man - 05/01/2022 -
                  06/01/2022
                </p>
                <input
                  type="date"
